...
class TestRunner:
    def __init__(self, sample_dir: str = "test-input", output_dir: str = "expected-output"):
    ...
    def run_tests(self) -> bool:
        ...
        if self.new_files:
            ...
            for file_path in self.new_files:
                ...
                print(f"    Run: unxml {file_path} > {expected_file}")
        ...
        # Return True if all tests passed (no changes or failures)
...
def main():
    ...
    runner = TestRunner(args.sample_dir, args.output_dir)
